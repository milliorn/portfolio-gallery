...
export const projectsData = [
  {
    h3: "Current Weather",
    p: "Simple app that does a search by city. Get full detailed information about the current weather and 7 day forecast. This project was bootstrapped with React and Tailwind CSS. It is powered by OpenWeather, GeoDB Cities and Unsplash",
    href: "https://github.com/milliorn/Current-Weather",
    message: "Get the Weather",
  },
  {
...
export const footerData = [
  {
    ...
    className:
      "mx-2 my-4 text-3xl bg-white text-lightBlue-600 sm:text-4xl border rounded border-lightBlue-600",
    icon: <SiLinkedin />,
  },
  {
  ...
  },
  {
    href: "https://github.com/milliorn",
    className:
      "mx-2 my-4 text-3xl text-black bg-white sm:text-4xl rounded-full border",
    icon: <SiGithub />,
  },
  {
